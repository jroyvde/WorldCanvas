console.log('timeManager.js loaded')
...
// Function: Set the opacity of the Night Cast based on the time of day
const setNightCastOpacity = () => {
...
const tick = () => {
    ...
    const minuteTime = 1000 / timeFactor    
